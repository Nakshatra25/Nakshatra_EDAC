...
desc employee;
insert into employee values(1,'Nakshatra');
insert into employee values(2,'Nakshu');
insert into employee values(3,'Nikita');
insert into employee values(4,'Nutan');
insert into employee values(5,'Neha');
